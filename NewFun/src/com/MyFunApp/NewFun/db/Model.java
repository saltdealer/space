...
public class Model {
	...
	public static String  dian_key="4567588052";
	public static String dian_value="49daffa44b814665aa2211b2914d9d94";
	public static String url_dian_cities_onlineString = "http://api.dianping.com/v1/metadata/get_cities_with_online_reservations";
	public static String url_dian_categories = "http://api.dianping.com/v1/metadata/get_categories_with_online_reservations";
	public static String url_dian_shopString = "http://api.dianping.com/v1/business/find_businesses";
	
	public static String online_citiesStrings= "[\"上海\",\"北京\",\"杭州\",\"广州\",\"南京\",\"苏州\",\"深圳\",\"成都\",\"重庆\",\"天津\",\"无锡\",\"厦门\",\"武汉\",\"西安\",\"沈阳\",\"大连\",\"青岛\",\"济南\",\"长春\",\"哈尔滨\",\"合肥\",\"郑州\",\"长沙\"]";
	public static String[] avarage_Strings = {"100元以下","100-200元","200元以上"};
	public static String online_categoriesStrings = "[\"江浙菜\",\"粤菜\",\"川菜\",\"湘菜\",\"北京菜\",\"东北菜\",\"云贵菜\",\"湖北菜\" ]";
	
	public final static int[] splash_bg = {R.drawable.guid1_01, R.drawable.guid2_01,R.drawable.guid3_01, R.drawable.guid4_01,R.drawable.guid5_01,R.drawable.guid6_01};
	...
	// shoplist中排序文本
	public static String[] SHOPLIST_THREELIST = { "默            认", "星级高优先" ,"评价高优先", "环境优先", "服务优先", "点评数量多优先", "距离近优先" , "格低优先", "价格高优先"};
	// shoplist中商区文本
	...
	public static String[] splash_intro_Strings = new String[]{"自动定位位置，发现精品餐点，与美食邂逅,享受生活中的每个惊喜","电影与美食的结合，让你享受光影和与美食的奇幻体验","与好友聚餐，享受生活的闲暇，随时开启","结识新的朋友，体验新的美食"};
